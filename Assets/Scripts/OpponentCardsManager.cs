...
public class OpponentCardsManager : MonoBehaviour
{
    ...
    private Quaternion cardRotation = Quaternion.Euler(-30, 180, 0); // Kartlarýn varsayýlan rotasyonu
    ...
    public void DrawInitialCards()
    {
        ...
        for (int i = 0; i < 3; i++)
        {
            ...
            selectedCard.transform.rotation = cardRotation; // Kartýn varsayýlan rotasyonunu ayarla
    ...
    public void CardPlayed(GameObject playedCard)
    {
        ...
        if (hiddenCards.Count > 0)
        {
            ...
            newCard.transform.rotation = cardRotation; // Kartýn varsayýlan rotasyonunu ayarla
        ...
        foreach (var card in visibleCards)
        {
            if (!card.activeSelf)
            {
                ...
                if (spawnPoint != null)
                {
                    ...
                    card.transform.rotation = cardRotation; // Kartýn varsayýlan rotasyonunu ayarla
                }
            }
        }
    }
