...
public class PlayerAgent : Agent, IPlayer
{
    public PlayerCardsManager ownCardsManager;
    ...
    public void PlayCard(int cardIndex, int targetIndex)
    {
        ...
        if (cardIndex >= 0 && cardIndex < ownCards.Count)
        {
            ...
            else if (cardType == "Attack")
            {
                ...
                else if (targetArena == opponentArena)
                {
                    AddReward(0.3f);
                }
            }
            ...
            if (targetArena != null)
            {
                if (cardType == "Heal" && targetArena == ownArena)
                {
                    ...
                    gameManager.PlayerPlayedCard(cardType, cardValue);
